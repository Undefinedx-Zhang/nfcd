...
class FPA_HRNet_CD(BaseModel):
    def __init__(self, num_classes, conf, loss_l=None, loss_alg=None, len_unsper=None, testing=False, pretrained=True):
        ...
        super(FPA_HRNet_CD, self).__init__()
        ...
        # Create the model
        pretrained_path = './models/backbones/pretrained/hrnetv2_w48_imagenet_pretrained.pth'
        self.encoder = Encoder_HRNet(pretrained_path=pretrained_path)

        # The main encoder
        upscale             = 4
        decoder_in_ch       = (48+96+192+384)//4
