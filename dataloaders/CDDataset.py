...
#             f.close()
#
#         elif self.split in ["train_unsupervised", "train_supervised"]:
...
#             f.close()
#
#             file_list = os.path.join('/sd1/kzq/nfcd/DATA/WHU_expand/WHU/list', f"{self.percnt_lbl}_{self.split}" + ".txt")
#
#             f = open(file_list, "r")
#             self.files.extend(f.readlines())
#             print("Extended data read successfully")
#             f.close()
#
#         else:
...
#         if self.split in ["train_unsupervised", "train_supervised"]:
#             image_name = self.files[index].strip()
#             if image_name.startswith("x_"):
#                 image_A_path = os.path.join('/sd1/kzq/nfcd/DATA/WHU_expand/WHU', 'A', image_name)
#                 image_B_path = os.path.join('/sd1/kzq/nfcd/DATA/WHU_expand/WHU', 'B', image_name)
#                 label_path = os.path.join('/sd1/kzq/nfcd/DATA/WHU_expand/WHU', 'label', image_name)
#             else:
